# Generated by Powerlevel10k configuration wizard on 2023-10-10 at 00:08 CDT.
...
() {
  ...
  # Disable gitstatus: distutils missing on this machine (Python 3.12+), daemon can't provision.
